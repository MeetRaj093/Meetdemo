...
class WCV_Vendors {
 ...
 // is_vendor_product_page()
	...
	public static function add_rewrite_rules() {
		...
		//add_rewrite_rule( $permalink . '/([^/]*)/page/([0-9]+)', 'index.php?author_name=$matches[1]&post_type=product&vendor_shop=$matches[2]&paged=$matches[3]', 'top' );
		add_rewrite_rule( $permalink . '/([^/]*)', 'index.php?post_type=product&vendor_shop=$matches[1]', 'top' );
	//	add_rewrite_rule( $permalink . 'vendor/(.?.+?)/product/?(.?.+?)/?$', 'index.php?author_name=$matches[1]&post_type=product&product=$matches[2]', 'top' );
