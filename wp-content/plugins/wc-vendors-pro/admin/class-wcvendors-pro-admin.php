...
class WCVendors_Pro_Admin {
	...
	public function enqueue_scripts() {
		...
		$admin_args = array(
			...
			'delete_report_confirm'      => __( 'Are you sure you want to delete this report?', 'wcvendors-pro' ),
			'bulk_delete_report_confirm' => __( 'Are you sure you want to delete these reports?', 'wcvendors-pro' ),
		);
