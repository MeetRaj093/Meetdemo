		...
		wc_get_template(
			...
			array(
				...
				'national_details'           => array(
					...
					'value' => array(
						'national_minimum_shipping_fee'  => __( 'Minimum shipping charge', 'wcvendors-pro' ),
						'national_maximum_shipping_fee'  => __( 'Maximum shipping charge', 'wcvendors-pro' ),
						'national_free_shipping_product' => __( 'Free shipping charge if spend is over', 'wcvendors-pro' ),
						'national_min_charge'            => __( 'Minimum shipping charge per order', 'wcvendors-pro' ),
						'national_max_charge'            => __( 'Maximum shipping charge per order', 'wcvendors-pro' ),
						'national_free_shipping_order'   => __( 'Free shipping if the order spend is over', 'wcvendors-pro' ),
					),
				),
				...
				'international_details'      => array(
					...
					'value' => array(
						'international_minimum_shipping_fee' => __( 'Minimum shipping charge per order', 'wcvendors-pro' ),
						'international_maximum_shipping_fee' => __( 'Maximum shipping charge per order', 'wcvendors-pro' ),
						'international_free_shipping_product' => __( 'Free shipping charge per order spend over', 'wcvendors-pro' ),
						'international_min_charge' => __( 'Minimum shipping charge per order', 'wcvendors-pro' ),
						'international_max_charge' => __( 'Maximum shipping charge per order', 'wcvendors-pro' ),
						'international_free_shipping_order' => __( 'Free shipping if the order spend is over', 'wcvendors-pro' ),
					),
				),
