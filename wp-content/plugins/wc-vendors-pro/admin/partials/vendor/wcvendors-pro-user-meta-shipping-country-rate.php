...
$regions = apply_filters( 'wcvendors_shipping_table_regions', $regions );
?>
				...
				<table>
							...
							<tr>
								...
								<td class="country">
									<select name="_wcv_shipping_countries[]" id="_wcv_shipping_countries[]"
										...
										echo $allow_ewe && isset( $regions['EWE'] ) ? '<option value="country:EWE" ' . selected( esc_attr( 'country:' . $rate['country'] ), 'country:EWE', false ) . '>' . __( 'Everywhere else', 'wcvendors-pro' ) . '</option>' : '';
										?>
					...
					<tr>
						<th colspan="7">
							...
							$file_data_row .= $allow_ewe && isset( $regions['EWE'] ) ? '<option value="country:EWE" ' . selected( esc_attr( 'country:' . $rate['country'] ), 'country:EWE', false ) . '>' . __( 'Everywhere else', 'wcvendors-pro' ) . '</option>' : '';
