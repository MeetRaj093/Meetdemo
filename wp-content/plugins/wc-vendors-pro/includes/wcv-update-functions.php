...
if ( ! function_exists( 'wcv_create_product_report_table' ) ) {
	/**
	 * Create the product report table
	 *
	 * Stores product report data.
	 *
	 * @since    1.8.3
	 */
	function wcv_create_product_report_table() {
		global $wpdb;
		...
		$sql = "CREATE TABLE IF NOT EXISTS $table_name (
			...
			report_notes LONGTEXT,
			report_respond_notes LONGTEXT,
			respond_sent_to bigint(20) NOT NULL,
