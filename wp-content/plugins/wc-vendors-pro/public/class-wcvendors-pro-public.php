	...
	public function enqueue_scripts() {
		...
		if ( is_product() ) {
			...
			if ( is_user_logged_in() ) {
				...
				wp_register_script( 'wcv-product-reports-script', $this->base_dir . 'assets/js/product-reports' . $this->suffix . '.js', array( 'jquery' ), WCV_PRO_VERSION, true );
				wp_enqueue_script( 'wcv-product-reports-script' );

				wp_register_style( 'wcv-product-reports-style', $this->base_dir . 'assets/css/product-reports' . $this->suffix . '.css', array(), WCV_PRO_VERSION );
