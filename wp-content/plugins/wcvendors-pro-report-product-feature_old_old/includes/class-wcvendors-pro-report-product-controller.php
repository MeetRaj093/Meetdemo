...
class WCVendors_Pro_Product_Report_Controller {
	...
	public function __construct() {
		...
		add_filter( 'wcv_product_row_status', array( $this, 'display_report_product_notice' ), 10, 6 );
	}
	...
	public function report_product_admin_notices() {
		...
		$respond_nonce = isset( $_GET['respond_nonce'] ) ? sanitize_text_field( $_GET['respond_nonce'] ) : '';
	 ...
	 */
	public function display_report_product_notice( $status, $product_status, $type, $date, $stock, $product ) {
