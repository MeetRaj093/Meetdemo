...
class WCVendors_Pro {
	...
	public function __construct() {
		...
		$this->wcvendors_pro_report_product_form    = new WCVendors_Pro_Report_Product_Form();
		$this->wcvendors_pro_report_product     = new WCVendors_Pro_Admin_Report_Product();
		...
		$this->wcvendors_pro_report_product_controller     = new WCVendors_Pro_Product_Report_Controller();
	...
	private function load_dependencies() {
		...
		include_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-wcvendors-pro-admin-report-product.php';
		...
		include_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wcvendors-pro-report-product-controller.php';
		include_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wcvendors-pro-report-product-table.php';
		...
		include_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/forms/class-wcvendors-report-product-form.php';
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'woocommerce_product_meta_end', $this->wcvendors_pro_report_product_form, 'report_product_form_content', 10, 1 );
