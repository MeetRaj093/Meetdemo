...
return 0; }
			...
			if ( ! isFinite( this._slidesPerPage )) {
this._slidesPerPage = 1; }
...
return; }
		...
		_onTouchMove: function (event) {
			if (event.touches.length > 1) {
return; /* multitouch event, not my problem. */ }
		...
		_onAnimationFrame: function () {
			...
			if ( ! swipeData || this._scrolling || this._touchMoveIsFirstTouchMove) {
return; }
