...
/**
 * WCV_CSV_Exporter Class.
 */
abstract class WCV_CSV_Exporter {
	 ...
	 * @var string
	 */
	protected $filename = 'wcvendors-product-export.csv';
	...
	public function get_column_names() {
		return apply_filters( "wcvendors_{$this->export_type}_export_column_names", $this->column_names, $this );
	}
	...
	public function get_delimiter() {
		return apply_filters( "wcvendors_{$this->export_type}_export_delimiter", $this->delimiter );
	}
	...
	public function get_filename() {
		return sanitize_file_name( apply_filters( "wcvendors_{$this->export_type}_export_get_filename", $this->filename ) );
	}
	...
	protected function export_rows() {
		...
		return apply_filters( "wcvendors_{$this->export_type}_export_rows", ob_get_clean(), $this );
	}
	...
	public function get_limit() {
		return apply_filters( "wcvendors_{$this->export_type}_export_batch_limit", $this->limit, $this );
	}
