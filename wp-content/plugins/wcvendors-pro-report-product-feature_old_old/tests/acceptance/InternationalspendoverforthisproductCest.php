Free shipping for spend over for this product:-
<?php
class InternationalspendoverforthisproductCest
{
...
$I->fillField('#_shipping_fee_international_free_shipping_order','250');
